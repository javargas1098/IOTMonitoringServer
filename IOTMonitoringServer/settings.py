...
ALLOWED_HOSTS = ["localhost", "ec2-54-166-183-85.compute-1.amazonaws.com"]
...
DATABASES = {
    "default": {
        ...
        "HOST": "ec2-52-91-205-191.compute-1.amazonaws.com",  # Dirección IP de la base de datos
...
MQTT_HOST = "ec2-44-202-159-71.compute-1.amazonaws.com"
